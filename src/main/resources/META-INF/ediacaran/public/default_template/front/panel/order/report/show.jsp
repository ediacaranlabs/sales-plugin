							...
							<ec:data-result var="response">
								...
								<ed:row>
									<ed:col classStyle="qty form-group has-feedback">
										<ec:textarea maxlength="128" id="messageField" rows="2" name="message" form="sendMessageOrderReport" readonly="${vars.orderReport.status == 'CLOSED'}" ></ec:textarea>
								...
								<ed:row>
									<ed:col>
										<ec:button label="#{product_table.form.button_message.label}" form="sendMessageOrderReport" style="success" bundle="${messages}"
											enabled="${vars.orderReport.status != 'CLOSED'}" 
