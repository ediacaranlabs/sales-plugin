...
<fmt:setBundle basename="system.templates.front.default_template.cart.user_details_br" var="sys_messages"/>
<!-- row -->
<div class="row">
...
<div class="row">
	<div class="col-sm-6 col-md-6 col-lg-6">
		<div class="form-group col-sm-12 col-md-12 col-lg-12">
		<!-- cpf_cnpj -->
			<label class="control-label" for="customer.document"><fmt:message
				key="cart_user_details.form.document" bundle="${sys_messages}" /></label>
			<script type="text/javascript">
				ignoreValidation = ${sessionScope.cart.total.signum() == 0? 'true' : 'false' };
			</script>
			<c:if test="${empty vars.customer.document}">
				<input value="${vars.customer.document}" class="form-control input-df" type="text" name="customer.document" 
					placeholder="">
			</c:if>
			<c:if test="${!empty vars.customer.document}">
				<input value="00000000000" type="hidden" name="customer.document">
				<input disabled value="**************" class="form-control input-df" type="text" name="customer.document" 
					placeholder="">
			</c:if>
		<!-- /cpf_cnpj -->
		</div>
...
<!-- /row -->
<script src="${pageContext.request.contextPath}/templates/shared/default_template/resources/js/util.js" charset="utf-8"></script>
<script src="${pageContext.request.contextPath}/templates/front/default_template/cart/js/language/${locale}/user-details-br.js" charset="utf-8"></script>
<script src="${pageContext.request.contextPath}/templates/front/default_template/cart/js/user-details-br.js" charset="utf-8"></script>