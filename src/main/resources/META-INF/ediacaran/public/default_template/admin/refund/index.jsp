...
<ec:box>
	...
	<ec:box-body>
		<ec:data-table id="refundSearchForm" action="${plugins.ediacaran.sales.web_path}${plugins.ediacaran.front.admin_context}/refunds/search">
			<ed:row>
				<ed:col size="3">
				...
				<ed:col size="2">
	    			<ec:dateField label="#{form.from.label}" name="startDate" bundle="${messages}">
	    				<ec:event type="change">
							var $form = $.AppContext.utils.getById('refundSearchForm');
			...
			<ec:data-result var="response">
				<ec:table>
					<ec:table-header>
						...
						<ec:table-col><ec:center><fmt:message key="table.refundDate" bundle="${messages}"/></ec:center></ec:table-col>
					...
					<ec:table-body>
						...
						<ec:table-row>
							...
							<ec:table-col><ec:center>!{item.refundDate}</ec:center></ec:table-col>
							<ec:table-col>
								<ec:center>
								<ec:button icon="search" style="info" actionType="button">
									<ec:event type="click">
										$.AppContext.utils.updateContent('#!${plugins.ediacaran.sales.web_path}${plugins.ediacaran.front.admin_context}/refunds/edit/!{item.id}');
									</ec:event>
								</ec:button>
								</ec:center>
							</ec:table-col>
