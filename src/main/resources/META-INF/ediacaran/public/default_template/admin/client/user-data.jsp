...
<ec:tabs>
	<ec:tabs-item title="Billing address" active="true">
		<ed:row>
			<ed:col>
				<ec:radio label="Use default address" name="billingAddress" value="default" selected="true"/>
			</ed:col>
		</ed:row>
		<ed:row>
			<ed:col>
...
<ec:jsTemplate>
				<span formgroup="billingAddressList" formgrouptype="index">
					<ec:accordion>
						<ec:accordion-item title="${vars.client.address} ${vars.client.complement} ${vars.client.city} ${vars.client.region} ${vars.client.country.name} - ${vars.client.zip} (default)">
							<ed:row>
