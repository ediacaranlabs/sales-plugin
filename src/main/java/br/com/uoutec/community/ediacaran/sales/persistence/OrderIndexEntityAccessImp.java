...
@RequestScoped
public class OrderIndexEntityAccessImp 
	extends AbstractEntityAccess<Order, OrderIndexEntity>
	implements OrderIndexEntityAccess {

	public OrderIndexEntityAccessImp() {
		super(null);
	}
	
	@Inject
	public OrderIndexEntityAccessImp(EntityManager entityManager) {
		super(entityManager);
	}
	
	@Override
	protected OrderIndexEntity toPersistenceEntity(Order entity)
			throws Throwable {
		return new OrderIndexEntity(entity);
	}

	@Override
	protected Order toEntity(OrderIndexEntity entity) throws Throwable {
	...
	@Override
	protected Serializable getPersistenceID(OrderIndexEntity value)
			throws Throwable {
		return value.getId();
	}
