...
public interface InvoiceRegistry extends PublicBean{
	...
	void cancelInvoice(Invoice invoice, String justification) throws RefundRegistryException, OrderRegistryException, InvoiceRegistryException, ShippingRegistryException, OrderReportRegistryException;
