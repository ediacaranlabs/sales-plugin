...
public class OrderReportSearchPubEntity extends AbstractPubEntity<OrderReportSearch> {
	...
	@Override
	protected boolean isEqualId(OrderReportSearch instance) throws Throwable {
		return false;
	}

	@Override
	protected boolean hasId(OrderReportSearch instance) throws Throwable {
		return false;
	}

	@Override
	protected OrderReportSearch reloadEntity() throws Throwable {
	...
	@Override
	protected OrderReportSearch createNewInstance() throws Throwable {
		return new OrderReportSearch();
	}

	@Override
	protected void copyTo(OrderReportSearch o, boolean reload, boolean override,
